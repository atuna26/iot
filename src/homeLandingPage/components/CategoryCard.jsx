    ...
    <div className="flex flex-col items-center w-full min-h-[300px] max-w-[450px] col-span-1">
      ...
      <div className={`w-full grid ${props.width} gap-2`}>
        ...
        {props.parameters.map((parameter) => (
          <ProductCard key={parameter.key} deviceKey={parameter.key} serialNumber={props.all.serialNumber}  icon={parameter.icon} name={parameter.label} status={parameter.status} isIncludePercantage={parameter.isIncludePercantage} rowSpan={parameter.rowSpan} colSpan={parameter.colSpan} color={parameter.color} visualization={parameter.visualization} />
        ))}
