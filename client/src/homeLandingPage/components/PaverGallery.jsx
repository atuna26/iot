...
const PaverGallery = () => {
  return (
    <section className={`flex flex-col w-full justify-center items-center gap-3 pt-3`}>
      <h2 className='text-primary text-3xl font-light font-abel'> <span className="border-t-2 border-l-2 pl-1">Paver</span><span className="border-b-2 border-r-2 pr-1"> Galeri</span> </h2>
